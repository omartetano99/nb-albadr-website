...
const content = {
  en: {
    ...
    testimonials: [
      {
        content: "NB Albadar transformed our corporate event into an unforgettable experience. Their attention to detail and professional approach exceeded our expectations.",
      ...
      {
        content: "Working with NB Albadar was a game-changer for our brand. Their strategic approach and flawless execution made all the difference.",
        author: "Emily Chen",
        role: "Brand Manager",
